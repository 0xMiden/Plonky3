...
use p3_fri::{SingleMatrixPcs, create_test_fri_params};
use p3_matrix::Matrix;
use p3_matrix::dense::RowMajorMatrix;
use p3_merkle_tree::MerkleTreeMmcs;
use p3_symmetric::{PaddingFreeSponge, TruncatedPermutation};
use p3_uni_stark::{StarkConfig, prove_single_matrix_pcs, verify_single_matrix_pcs};
...
type Pcs = SingleMatrixPcs<Val, Dft, ValMmcs, ChallengeMmcs>;
...
fn test_incorrect_public_value() {
    ...
    prove_single_matrix_pcs(&config, &FibonacciAir {}, trace, &pis);
}
